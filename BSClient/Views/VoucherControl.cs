...
namespace BSClient
{
    public partial class VoucherControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public VoucherControl()
        {
            ...
            // if(PGenID.arr)
          //  string VouID = PGenID.GenID("VOU");
          //  string VouID1 = PGenID.GenID("VOU");
          //  string VDe = PGenID.GenID("VDe");
          //  string VDe1 = PGenID.GenID("VDe");
          //  string VouID2 = PGenID.GenID("VOU");
        ...
        private void gridViewDinhKhoan_ShowingEditor(object sender, CancelEventArgs e)
        {
            ...
            //    if (view.FocusedColumn.FieldName == "TKNumber" && view.ActiveEditor is SearchLookUpEdit)
            //    {
            //        SearchLookUpEdit edit = (SearchLookUpEdit)view.ActiveEditor;
            //        int carTypeId = (int)view.GetFocusedRowCellValue("TKNumber");
        ...
        void initControltoGridview()
        {
            ...
            // rsItemlookup.ShowOnEnterKey = true;
            //rsItemlookup_Popup += rsItemlookup_Popup();
        ...
        private void gridViewDinhKhoan_CustomRowCellEdit(object sender, CustomRowCellEditEventArgs e)
        {
        ...
        {
            GridView view = sender as GridView;
            if (e.Column.FieldName == "GeneralLedgerName" && e.RowHandle == view.FocusedRowHandle)
            {
                if (view.GetRowCellValue(e.RowHandle, "GeneralLedgerName") != null && view.GetRowCellValue(e.RowHandle, "TKNumber") != null)
                {
                    MaterialNVController controller = new MaterialNVController();
                    List<MaterialCheck> MaterialCheckData = controller.GetMaterialCheck(view.GetRowCellValue(e.RowHandle, "TKNumber").ToString(), view.GetRowCellValue(e.RowHandle, "GeneralLedgerName").ToString());
        ...
        private void gridViewDinhKhoan_RowUpdated(object sender, DevExpress.XtraGrid.Views.Base.RowObjectEventArgs e)
        {
            //GridView view = sender as GridView;
            //view.Columns["TKNumber"].ToString();
            //if (view.Columns["GeneralLedgerName"] != null && view.Columns["TKNumber"] != null)
            //{
            //    MaterialNVController controller = new MaterialNVController();
            //    List<MaterialCheck> MaterialCheckData = controller.GetMaterialCheck(view.Columns["TKNumber"].ToString(), view.Columns["GeneralLedgerName"].ToString());
            //    bool msgCode = MaterialCheckData.Exists(s => s.msgCode == "0");
            //    if (msgCode)
            //    {
            //        // view.RowStyle
        ...
        private void searchLookUpEditVoucherTypeXemChungTU_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                searchLookUpEditVoucherTypeXemChungTU.ShowPopup();//.PopupView.ShowFindPanel();
            }
        }
        ...
        private void searchLookUpEditChungTuTypeDK_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                searchLookUpEditChungTuTypeDK.ShowPopup();//.PopupView.ShowFindPanel();
            }
        }
