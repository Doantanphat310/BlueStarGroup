...
{
    public partial class SoCaiChiTietReport : XtraUserControl
    {
        ...
        private void InitGridView()
        {
            ...
            this.Main_GridView.AddColumn("VoucherDate", "Ngày GS", 100, false);
            this.Main_GridView.AddColumn("VoucherNo", "Số CT", 70, false);
            this.Main_GridView.AddColumn("Description", "Nội Dung", 250, false);
            this.Main_GridView.AddColumn("AccountID", "Tài Khoản", 100, false);
            this.Main_GridView.AddColumn("ThongKe", "Thống Kê", 120, false);
